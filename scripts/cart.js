...
export class Cart {
  ...
  register_cart_changes(container, cb_html_item_generator) {
    if (!container || !cb_html_item_generator) return
    this.cart_changes_listeners[container] = cb_html_item_generator;
  }

  print_cart_changes_listener() {
    console.log([...Object.entries(this.cart_changes_listeners)]);
  }
  ...
  onUpdate() {
    ...
    let iter = Object.entries(this.cart_changes_listeners)
    console.log(iter)
    for (let [container, cb] of iter) {
